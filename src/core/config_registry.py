...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "AGENT_SIMULATION_DATE": {
        "title": "Agent Historical Simulation As-Of",
        "description": "Optional calendar date YYYY-MM-DD. When set, the Agent uses only OHLCV and indicators on or before this date; web search, fundamentals, chip, and live market tools are disabled or clamped. Clear to return to live analysis.",
        "category": "agent",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
